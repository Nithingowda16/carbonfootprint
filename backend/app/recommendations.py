...
def get_recommendations():
    ...
    if highest_category == 'transport':
        insights.append("Your transport emissions are elevated. Swapping driving for walking shorter errands can reduce carbon footprint by 15%.")
    elif highest_category == 'home':
        insights.append("AC and heating make up the bulk of your home energy load. Using natural ventilation is highly effective.")
    elif highest_category == 'food':
        insights.append("A meat-heavy diet contributes significantly to your footprint. Consider incorporating meat-free days.")
    else:
        insights.append("Landfill waste creates methane. Separating organic scraps for composting decreases waste footprint by 40%.")
        
    insights.append(f"Based on your profile, implementing all suggestions could save up to {sum(r['annual_saving'] for r in recommendations):.1f} kg CO2 annually!")
